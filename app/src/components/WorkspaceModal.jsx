                ...
                <div className="flex flex-wrap gap-3 relative">
                  {PREDEFINED_GRADIENTS.map((gradient, index) => (
                    <button
                      ...
                      className={`w-8 h-8 rounded-full transition-transform hover:scale-110 outline outline-1 outline-transparent ${avatarStyle === gradient ? 'ring-2 ring-white ring-offset-2 ring-offset-background' : 'border border-border'}`}
                  ...
                  <button 
                    ...
                    className={`w-8 h-8 rounded-full border border-border flex items-center justify-center bg-card transition-transform hover:scale-110 outline outline-1 outline-transparent ${showColorPicker ? 'ring-2 ring-white ring-offset-2 ring-offset-background' : ''}`}
                    title="Własny kolor"
                  >
