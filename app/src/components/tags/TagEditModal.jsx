          ...
          <div className="flex flex-wrap items-center gap-2">
            {TAG_COLORS.map(color => (
              <button
                ...
                className={`w-6 h-6 rounded-full flex items-center justify-center transition-transform hover:scale-110 outline outline-1 outline-transparent ${color.bg}`}
              >
            ...
            <div className="relative ml-2">
              <button
                ...
                className="w-6 h-6 rounded-full flex items-center justify-center transition-transform hover:scale-110 outline outline-1 outline-transparent relative"
                style={{
